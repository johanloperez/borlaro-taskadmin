...
namespace TaskAdmin.Infrastructure.Settings;
...
public class OrganizationSettings(TaskAdminDbContext db, IConfiguration configuration, SecretProtector protector)
{
