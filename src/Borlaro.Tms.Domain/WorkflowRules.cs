...
public static class WorkflowRules
{
    ...
    /// <summary>Si en esta etapa el trabajo empieza de verdad.
    ///
    /// Es el momento en que la fecha de entrega deja de ser opcional: una tarea en el backlog
    /// dentro de tres meses no tiene compromiso con nadie y ponerle fecha es inventar, pero algo
    /// que alguien ya está haciendo sin fecha es trabajo que nadie sabe cuándo llega.</summary>
    public static bool StartsWork(WorkflowStage stage) => stage.Category == StageCategory.InProgress;
}
