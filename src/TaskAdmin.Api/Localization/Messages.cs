...
namespace TaskAdmin.Api.Localization;
...
public static class Messages
{
    ...
    private static readonly Dictionary<string, Dictionary<Key, string>> Catalog = new()
    {
        ...
        ["en"] = new()
        {
            ...
            [Key.VerifySubject] = "Confirm your TaskAdmin account",
            [Key.VerifyBody] =
                "Hi {name}. To finish creating “{organization}”, confirm this address with the link below. It expires in 24 hours.",
            [Key.AlreadyRegisteredSubject] = "You already have a TaskAdmin account",
            [Key.AlreadyRegisteredBody] =
        ...
        ["pt"] = new()
        {
            ...
            [Key.VerifySubject] = "Confirme sua conta do TaskAdmin",
            [Key.VerifyBody] =
                "Olá {name}. Para terminar de criar “{organization}”, confirme este endereço com o link abaixo. Vence em 24 horas.",
            [Key.AlreadyRegisteredSubject] = "Você já tem conta no TaskAdmin",
            [Key.AlreadyRegisteredBody] =
...
public static class LanguageExtensions
{
    ...
    {
        var claim = context.User.FindFirstValue(TaskAdmin.Api.Auth.TokenService.LanguageClaim);
