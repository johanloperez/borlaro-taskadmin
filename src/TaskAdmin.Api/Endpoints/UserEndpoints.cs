...
public static class UserEndpoints
{
    ...
    public static IEndpointRouteBuilder MapUserEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        users.MapGet("/", async (TaskAdminDbContext db, CancellationToken ct) =>
        {
    ...
    private static Task<bool> AnotherAdminRemainsAsync(TaskAdminDbContext db, Guid excludingId, CancellationToken ct) =>
    ...
    private static async Task<AdminUserDto> OneAsync(TaskAdminDbContext db, Guid id, CancellationToken ct) =>
        await db.Users
            .AsNoTracking()
            .Where(u => u.Id == id)
            .Select(u => new AdminUserDto(
