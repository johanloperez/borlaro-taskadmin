...
using TaskAdmin.Api.Realtime;
using TaskAdmin.Api.Tenancy;
...
// ── Servicios ────────────────────────────────────────────────────────────────
builder.Services.AddDbContext<TaskAdminDbContext>(options =>
...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "TaskAdmin API", Version = "v1" });
