...
public static class AuthEndpoints
{
    public static IEndpointRouteBuilder MapAuthEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapGet("/users", async (TaskAdminDbContext db, CancellationToken ct) =>
        {
    ...
    internal static async Task<UserResponse> ToResponseAsync(
        TaskAdminDbContext db, User u, CancellationToken ct)
    {
    ...
    internal static async Task<bool> SuspendedAsync(TaskAdminDbContext db, User user, CancellationToken ct)
    {
        var organization = await db.Organizations
            .AsNoTracking()
