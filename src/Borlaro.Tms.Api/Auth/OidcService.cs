...
public enum OidcFailure
{
    ...
    Domain,
    /// <summary>Nadie con ese email en Borlaro TMS. No se crea: alguien tiene que darlo de alta.</summary>
    NoAccount,
...
/// <summary>Entrar con las credenciales que la persona ya tiene, sin que Borlaro TMS guarde otra
/// contraseña más.
///
    ...
    ILogger<OidcService> logger)
{
    ...
    /// abierto: un mail con el botón real de Borlaro TMS que termina en otro dominio.</summary>
