...
public class BorlaroTmsDbContext : DbContext
{
    public BorlaroTmsDbContext(DbContextOptions<BorlaroTmsDbContext> options) : base(options) { }
    ...
    protected override void OnModelCreating(ModelBuilder b)
    {
        ...
        b.Entity<WorkItemTimeExtension>(e =>
        {
            ...
            // Se lee siempre igual: «las ampliaciones de esta tarea, de la más vieja a la más
            // nueva», que es la historia de cuánto creció y cuándo.
